...
- `app/page.tsx`: Holographic UI implementation with 3D card tilt and real-time glare effects.

## Data Structure
The AI generates a JSON object with `title`, `narrative` (olympic/paralympic), `rarity`, `stats`, `era`, and `discipline`.
